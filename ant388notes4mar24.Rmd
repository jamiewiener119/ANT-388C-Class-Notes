...
```{r}
(m <- lm(ECV ~ Group_size,s))
```

Repeat the analysis above for different groups of primates (Catarrhini, Platyrrhini, Strepsirhini) separately. Do your regression coefficients differ? How might you determine this?
